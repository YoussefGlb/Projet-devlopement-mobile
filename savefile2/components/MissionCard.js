      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.containerInfo}>{mission.containerType}</Text>
          </View>
        </View>
      ...
      <View style={styles.routeContainer}>
        ...
        <View style={styles.routeDetails}>
          <View style={styles.cityRow}>
            ...
            <Text style={styles.cityName}>{mission.departureCity}</Text>
            <Text style={styles.timeText}>{formatTime(mission.pickupTime)}</Text>
          </View>

          <View style={styles.cityRow}>
            <Text style={styles.cityLabel}>Arrivée</Text>
            <Text style={styles.cityName}>{mission.arrivalCity}</Text>
            <Text style={styles.timeText}>
              {formatTime(mission.expectedDropoffTime)}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoText}>
            {(mission.estimatedFuelCost ?? mission.actualFuelCost) + ' DH'}
          </Text>
        </View>
        ...
        {mission.hoursWorked && (
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>
              {mission.hoursWorked.toFixed(1)}h
            </Text>
          </View>
        )}
      </View>
